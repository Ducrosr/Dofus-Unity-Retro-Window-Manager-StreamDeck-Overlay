...
_EN: dict[str, str] = {
    ...
    "Choisir la version de Dofus": "Choose the Dofus version",
    "Configurer la détection": "Configure detection",
    "Tester le focus": "Test window focus",
    "Configurer l’overlay": "Configure the overlay",
    "Stream Deck facultatif": "Optional Stream Deck",
    "Étape {current} sur {total}": "Step {current} of {total}",
    "Configurer plus tard": "Set up later",
    "Terminer": "Finish",
    "Bienvenue dans Dofus Window Manager. Cet assistant configure les éléments essentiels sans modifier vos profils de personnages.": "Welcome to Dofus Window Manager. This assistant configures the essentials without changing your character profiles.",
    "Les traductions anglaise et espagnole ont été réalisées avec l’aide d’une IA et peuvent être corrigées depuis le dépôt officiel.": "The English and Spanish translations were created with AI assistance and can be corrected through the official repository.",
    "Sélectionnez la version utilisée maintenant. Vous pourrez changer de mode à tout moment sans redémarrer l’application.": "Select the version you are using now. You can change mode at any time without restarting the application.",
    "Ouvrez vos clients Dofus, puis lancez une analyse. La synchronisation en temps réel évite les scans complets inutiles.": "Open your Dofus clients, then run a scan. Real-time synchronization avoids unnecessary full scans.",
    "Analyser maintenant": "Scan now",
    "Analyse en cours…": "Scanning…",
    "Fenêtres détectées : {count}": "Detected windows: {count}",
    "Ce test active brièvement la première fenêtre détectée, puis ramène cet assistant au premier plan.": "This test briefly activates the first detected window, then brings this assistant back to the foreground.",
    "Tester la première fenêtre": "Test the first window",
    "Aucune fenêtre à tester. Ouvrez Dofus puis relancez l’analyse.": "There is no window to test. Open Dofus and run the scan again.",
    "La première fenêtre n’est plus disponible.": "The first window is no longer available.",
    "Échec du focus : {error}": "Focus failed: {error}",
    "Focus réussi sur {name}.": "Focus succeeded on {name}.",
    "L’aperçu est appliqué immédiatement. Les réglages resteront indépendants entre Unity et Retro.": "The preview is applied immediately. Settings will remain independent between Unity and Retro.",
    "Orientation": "Orientation",
    "Le Stream Deck n’est pas nécessaire : les boutons de l’application, l’overlay et les raccourcis clavier fonctionnent seuls.": "A Stream Deck is not required: the app buttons, overlay and keyboard shortcuts work on their own.",
    "Si vous possédez un Stream Deck, ouvrez maintenant le paquet officiel et confirmez son installation dans le logiciel Elgato.": "If you own a Stream Deck, open the official package now and confirm its installation in the Elgato software.",
    "Le paquet a été ouvert dans Stream Deck pour confirmation.": "The package was opened in Stream Deck for confirmation.",
    ...
    "Aperçu Stream Deck multi-modèles": "Multi-device Stream Deck preview",
    "Aperçu interactif des profils fournis": "Interactive preview of bundled profiles",
    "Modèle de Stream Deck": "Stream Deck model",
    "Ce profil propose {count} touches Personnage. Cliquez sur une touche pour tester son action ; les réglages visuels personnalisés restent gérés par Stream Deck.": "This profile provides {count} character keys. Click a key to test its action; custom visual settings remain managed by Stream Deck.",
    ...
    "Réintégrer": "Restore",
    "Profils": "Profiles",
    "Charger automatiquement un profil reconnu exactement": "Automatically load an exact recognized profile",
    "La reconnaissance compare les personnages et le mode Unity/Retro. En cas d’ambiguïté, aucun profil n’est chargé.": "Recognition compares characters and the Unity/Retro mode. If the result is ambiguous, no profile is loaded.",
    "Espacer les scans de contrôle lorsque la détection en temps réel est active": "Space out recovery scans while real-time detection is active",
    "Le rythme normal reprend automatiquement si la détection par événements est indisponible.": "The normal interval resumes automatically if event-based detection is unavailable.",
    "Créer un paquet de support…": "Create a support bundle…",
    "Créer un paquet de support anonymisé": "Create an anonymized support bundle",
    "Paquet de support": "Support bundle",
    "Impossible de créer le paquet : {error}": "Could not create the bundle: {error}",
    "Le paquet anonymisé a été créé. Relisez son contenu avant de le publier : une anonymisation automatique ne peut pas garantir qu’un texte libre ne contient aucune donnée personnelle.": "The anonymized bundle was created. Review its contents before publishing it: automatic anonymization cannot guarantee that free-form text contains no personal data.",
    "Simuler l’affichage…": "Simulate display…",
    "Simulation de l’affichage": "Display simulation",
    "Aperçu sans fenêtre Dofus": "Preview without a Dofus window",
    "Cet aperçu utilise les réglages enregistrés. Les clics et déplacements simulés n’activent aucune fenêtre et ne modifient pas l’ordre réel.": "This preview uses the saved settings. Simulated clicks and moves do not activate any window or change the real order.",
    "Personnage suivant": "Next character",
    "Basculer l’alerte": "Toggle alert",
    "Afficher la notification": "Show notification",
    "Équilibré": "Balanced",
    "Complet": "Complete",
    "Préréglages d’affichage": "Display presets",
    "Charger dans le formulaire": "Load into the form",
    "Simuler les réglages enregistrés…": "Simulate saved settings…",
    "Préréglage chargé dans le formulaire ; sélectionnez Appliquer pour l’enregistrer.": "Preset loaded into the form; select Apply to save it.",
    "Capturer": "Capture",
    "Capturer un raccourci": "Capture a shortcut",
    "Appuyez maintenant sur la combinaison souhaitée.": "Press the desired key combination now.",
    "Touche non prise en charge ; essayez une lettre, un chiffre, F1 à F24 ou une touche de navigation.": "Unsupported key; try a letter, digit, F1 to F24, or a navigation key.",
    "Erreur : {error}": "Error: {error}",
    "Conflit : {spec} est utilisé par {labels}.": "Conflict: {spec} is used by {labels}.",
    "Toutes les combinaisons sont valides dans l’application.": "All combinations are valid within the application.",
    "Windows n’a pas pu enregistrer certaines combinaisons :\n\n{details}\n\nChoisissez une autre combinaison puis réessayez.": "Windows could not register some combinations:\n\n{details}\n\nChoose another combination and try again.",
    "Points de restauration locaux": "Local restore points",
    "Aucun point de restauration": "No restore point",
    "Aucun point de restauration valide n’est sélectionné.": "No valid restore point is selected.",
    "Créer un point maintenant": "Create a point now",
    "Restaurer le point sélectionné": "Restore the selected point",
    "Accessibilité": "Accessibility",
    "Contraste renforcé": "High contrast",
    "Réduire les animations et désactiver le clignotement": "Reduce motion and disable blinking",
    "Échelle du texte et de l’interface": "Text and interface scale",
    "Installer ou réparer le plugin Stream Deck": "Install or repair the Stream Deck plugin",
    "État du plugin Stream Deck": "Stream Deck plugin status",
    "Installer/réparer maintenant ?": "Install/repair now?",
    "Réinstaller quand même le paquet fourni ?": "Reinstall the bundled package anyway?",
    "Réparer le plugin…": "Repair plugin…",
    "Charger": "Load",
    "Enregistrer…": "Save…",
    "Gérer les profils…": "Manage profiles…",
    ...
    "Afficher le titre de l’overlay": "Show the overlay title",
    "Afficher les flèches de réorganisation": "Show reorder arrows",
    "Déverrouillé : glissez le titre ou la fine poignée supérieure pour déplacer l’overlay, une ligne pour la réordonner, ou la poignée ◢ pour le redimensionner.": "Unlocked: drag the title or thin top handle to move the overlay, a row to reorder it, or the ◢ handle to resize it.",
...
_ES: dict[str, str] = {
    ...
    "Langue": "Idioma",
    "Assistant de configuration": "Asistente de configuración",
    "Assistant de configuration…": "Asistente de configuración…",
    "Choisir la langue": "Elegir idioma",
    "Choisir la version de Dofus": "Elegir la versión de Dofus",
    "Configurer la détection": "Configurar la detección",
    "Tester le focus": "Probar el enfoque de ventana",
    "Configurer l’overlay": "Configurar el overlay",
    "Stream Deck facultatif": "Stream Deck opcional",
    "Étape {current} sur {total}": "Paso {current} de {total}",
    "Configurer plus tard": "Configurar más tarde",
    "Terminer": "Finalizar",
    "Bienvenue dans Dofus Window Manager. Cet assistant configure les éléments essentiels sans modifier vos profils de personnages.": "Te damos la bienvenida a Dofus Window Manager. Este asistente configura lo esencial sin modificar tus perfiles de personajes.",
    "Les traductions anglaise et espagnole ont été réalisées avec l’aide d’une IA et peuvent être corrigées depuis le dépôt officiel.": "Las traducciones al inglés y al español se realizaron con ayuda de IA y pueden corregirse desde el repositorio oficial.",
    "Sélectionnez la version utilisée maintenant. Vous pourrez changer de mode à tout moment sans redémarrer l’application.": "Selecciona la versión que utilizas ahora. Podrás cambiar de modo en cualquier momento sin reiniciar la aplicación.",
    "Ouvrez vos clients Dofus, puis lancez une analyse. La synchronisation en temps réel évite les scans complets inutiles.": "Abre tus clientes de Dofus y ejecuta un análisis. La sincronización en tiempo real evita análisis completos innecesarios.",
    "Analyser maintenant": "Analizar ahora",
    "Analyse en cours…": "Analizando…",
    "Fenêtres détectées : {count}": "Ventanas detectadas: {count}",
    "Ce test active brièvement la première fenêtre détectée, puis ramène cet assistant au premier plan.": "Esta prueba activa brevemente la primera ventana detectada y después vuelve a poner este asistente en primer plano.",
    "Tester la première fenêtre": "Probar la primera ventana",
    "Aucune fenêtre à tester. Ouvrez Dofus puis relancez l’analyse.": "No hay ninguna ventana que probar. Abre Dofus y vuelve a ejecutar el análisis.",
    "La première fenêtre n’est plus disponible.": "La primera ventana ya no está disponible.",
    "Échec du focus : {error}": "Error al enfocar: {error}",
    "Focus réussi sur {name}.": "Enfoque correcto en {name}.",
    "L’aperçu est appliqué immédiatement. Les réglages resteront indépendants entre Unity et Retro.": "La vista previa se aplica inmediatamente. Los ajustes seguirán siendo independientes entre Unity y Retro.",
    "Orientation": "Orientación",
    "Le Stream Deck n’est pas nécessaire : les boutons de l’application, l’overlay et les raccourcis clavier fonctionnent seuls.": "Stream Deck no es necesario: los botones de la aplicación, el overlay y los atajos de teclado funcionan por sí solos.",
    "Si vous possédez un Stream Deck, ouvrez maintenant le paquet officiel et confirmez son installation dans le logiciel Elgato.": "Si tienes un Stream Deck, abre ahora el paquete oficial y confirma su instalación en el software de Elgato.",
    "Le paquet a été ouvert dans Stream Deck pour confirmation.": "El paquete se ha abierto en Stream Deck para su confirmación.",
    ...
    "Aperçu Stream Deck multi-modèles": "Vista previa de Stream Deck para varios dispositivos",
    "Aperçu interactif des profils fournis": "Vista previa interactiva de los perfiles incluidos",
    "Modèle de Stream Deck": "Modelo de Stream Deck",
    "Ce profil propose {count} touches Personnage. Cliquez sur une touche pour tester son action ; les réglages visuels personnalisés restent gérés par Stream Deck.": "Este perfil ofrece {count} teclas de personaje. Haz clic en una tecla para probar su acción; los ajustes visuales personalizados siguen gestionándose en Stream Deck.",
    ...
    "Profils": "Perfiles",
    "Charger automatiquement un profil reconnu exactement": "Cargar automáticamente un perfil reconocido exactamente",
    "La reconnaissance compare les personnages et le mode Unity/Retro. En cas d’ambiguïté, aucun profil n’est chargé.": "El reconocimiento compara los personajes y el modo Unity/Retro. Si el resultado es ambiguo, no se carga ningún perfil.",
    "Espacer les scans de contrôle lorsque la détection en temps réel est active": "Espaciar los escaneos de control cuando la detección en tiempo real esté activa",
    "Le rythme normal reprend automatiquement si la détection par événements est indisponible.": "El intervalo normal se reanuda automáticamente si la detección por eventos no está disponible.",
    "Créer un paquet de support…": "Crear un paquete de soporte…",
    "Créer un paquet de support anonymisé": "Crear un paquete de soporte anonimizado",
    "Paquet de support": "Paquete de soporte",
    "Impossible de créer le paquet : {error}": "No se pudo crear el paquete: {error}",
    "Le paquet anonymisé a été créé. Relisez son contenu avant de le publier : une anonymisation automatique ne peut pas garantir qu’un texte libre ne contient aucune donnée personnelle.": "Se ha creado el paquete anonimizado. Revisa su contenido antes de publicarlo: la anonimización automática no puede garantizar que el texto libre no contenga datos personales.",
    "Simuler l’affichage…": "Simular visualización…",
    "Simulation de l’affichage": "Simulación de visualización",
    "Aperçu sans fenêtre Dofus": "Vista previa sin ventana de Dofus",
    "Cet aperçu utilise les réglages enregistrés. Les clics et déplacements simulés n’activent aucune fenêtre et ne modifient pas l’ordre réel.": "Esta vista previa usa los ajustes guardados. Los clics y movimientos simulados no activan ninguna ventana ni cambian el orden real.",
    "Personnage suivant": "Siguiente personaje",
    "Basculer l’alerte": "Alternar alerta",
    "Afficher la notification": "Mostrar notificación",
    "Équilibré": "Equilibrado",
    "Complet": "Completo",
    "Préréglages d’affichage": "Preajustes de visualización",
    "Charger dans le formulaire": "Cargar en el formulario",
    "Simuler les réglages enregistrés…": "Simular ajustes guardados…",
    "Préréglage chargé dans le formulaire ; sélectionnez Appliquer pour l’enregistrer.": "Preajuste cargado en el formulario; selecciona Aplicar para guardarlo.",
    "Capturer": "Capturar",
    "Capturer un raccourci": "Capturar un atajo",
    "Appuyez maintenant sur la combinaison souhaitée.": "Pulsa ahora la combinación deseada.",
    "Touche non prise en charge ; essayez une lettre, un chiffre, F1 à F24 ou une touche de navigation.": "Tecla no compatible; prueba una letra, un número, F1 a F24 o una tecla de navegación.",
    "Erreur : {error}": "Error: {error}",
    "Conflit : {spec} est utilisé par {labels}.": "Conflicto: {spec} está usado por {labels}.",
    "Toutes les combinaisons sont valides dans l’application.": "Todas las combinaciones son válidas dentro de la aplicación.",
    "Windows n’a pas pu enregistrer certaines combinaisons :\n\n{details}\n\nChoisissez une autre combinaison puis réessayez.": "Windows no pudo registrar algunas combinaciones:\n\n{details}\n\nElige otra combinación e inténtalo de nuevo.",
    "Points de restauration locaux": "Puntos de restauración locales",
    "Aucun point de restauration": "Sin punto de restauración",
    "Aucun point de restauration valide n’est sélectionné.": "No hay ningún punto de restauración válido seleccionado.",
    "Créer un point maintenant": "Crear un punto ahora",
    "Restaurer le point sélectionné": "Restaurar el punto seleccionado",
    "Accessibilité": "Accesibilidad",
    "Contraste renforcé": "Contraste alto",
    "Réduire les animations et désactiver le clignotement": "Reducir el movimiento y desactivar el parpadeo",
    "Échelle du texte et de l’interface": "Escala del texto y de la interfaz",
    "Installer ou réparer le plugin Stream Deck": "Instalar o reparar el plugin de Stream Deck",
    "État du plugin Stream Deck": "Estado del plugin de Stream Deck",
    "Installer/réparer maintenant ?": "¿Instalar/reparar ahora?",
    "Réinstaller quand même le paquet fourni ?": "¿Reinstalar de todos modos el paquete incluido?",
    "Réparer le plugin…": "Reparar plugin…",
    "Charger": "Cargar",
    "Enregistrer…": "Guardar…",
    "Gérer les profils…": "Gestionar perfiles…",
    ...
    "Afficher le titre de l’overlay": "Mostrar el título del overlay",
    "Afficher les flèches de réorganisation": "Mostrar las flechas de reordenación",
    "Déverrouillé : glissez le titre ou la fine poignée supérieure pour déplacer l’overlay, une ligne pour la réordonner, ou la poignée ◢ pour le redimensionner.": "Desbloqueado: arrastra el título o el control superior fino para mover el overlay, una fila para reordenarla o el control ◢ para cambiar su tamaño.",
