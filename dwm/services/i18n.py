...
_EN: dict[str, str] = {
    ...
    "L’affichage par défaut est restauré et l’overlay hors écran a été désactivé.": "The default display has been restored and the off-screen overlay has been disabled.",
...
_ES: dict[str, str] = {
    ...
    "L’affichage par défaut est restauré et l’overlay hors écran a été désactivé.": "Se ha restaurado la visualización predeterminada y se ha desactivado el overlay fuera de pantalla.",
