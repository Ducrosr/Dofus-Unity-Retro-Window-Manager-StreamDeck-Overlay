...
_EN: dict[str, str] = {
    ...
    "DWM crée automatiquement une Capture de fenêtre persistante par client détecté dans cette scène, sans limite fixe de 8 clients. Les captures des clients ouverts restent actives en permanence ; pendant les rotations, DWM ne change que leur opacité afin d’éviter une réacquisition WGC.": "DWM automatically creates one persistent Window Capture per detected client in this scene, with no fixed eight-client limit. Captures for open clients stay active at all times; during rotations, DWM only changes their opacity to avoid WGC reacquisition.",
...
_ES: dict[str, str] = {
    ...
    "DWM crée automatiquement une Capture de fenêtre persistante par client détecté dans cette scène, sans limite fixe de 8 clients. Les captures des clients ouverts restent actives en permanence ; pendant les rotations, DWM ne change que leur opacité afin d’éviter une réacquisition WGC.": "DWM crea automáticamente una Captura de ventana persistente por cada cliente detectado en esta escena, sin un límite fijo de ocho clientes. Las capturas de los clientes abiertos permanecen activas en todo momento; durante las rotaciones, DWM solo cambia su opacidad para evitar una nueva adquisición WGC.",
